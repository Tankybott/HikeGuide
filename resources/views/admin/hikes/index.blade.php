<x-app-layout>
    <div class="pt-8" x-data="{
        ...
        async load(query) {
            ...
            document.getElementById('hikes-results').innerHTML = await res.text();
        ...
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-bold text-gray-900">Hikes</h1>
            <a href="{{ route('admin.hikes.create') }}" class="px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white text-sm font-semibold rounded-lg transition-colors">
                + Add Hike
            </a>
        </div>
        ...
        >
            @include('admin.hikes.partials.table')
        </div>
        ...
        >
            ...
            >
                <h2 class="text-lg font-semibold text-gray-900 mb-2">Delete Hike</h2>
                <p class="text-sm text-gray-500 mb-6">
                    Are you sure you want to delete <span class="font-medium text-gray-800" x-text="deleteName"></span>?
                    This cannot be undone.
                </p>
                <form :action="'/admin/hikes/' + deleteId" method="POST">
                    @csrf
                    @method('DELETE')
